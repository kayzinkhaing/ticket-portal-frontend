<!-- src/pages/client/CommentItemClient.vue -->
<template>
  <div class="flex flex-col gap-3 relative">
    <div class="flex gap-3 group relative">
      ...
      <div class="flex-1 min-w-0">
        <div class="bg-[#1c1e2d] border border-white/5 rounded-2xl rounded-tl-none px-4 py-3 inline-block max-w-[95%] shadow-xl hover:border-white/20 transition-all">
