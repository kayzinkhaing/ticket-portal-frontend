<template>
  <ClientLayout>
    <template #header-actions>
      <router-link to="/client/create-ticket"
        class="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-violet-500/80 hover:bg-violet-500 text-white text-sm font-semibold transition-all hover:shadow-[0_0_24px_rgba(139,92,246,0.5)] active:scale-95"
        style="font-family:'Syne',sans-serif">+ New Ticket</router-link>
    </template>
